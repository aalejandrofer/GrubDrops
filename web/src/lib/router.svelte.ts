...
export const spaPaths: string[] = ['/', '/drops', '/priority', '/settings', '/settings/notifications', '/settings/experimental', '/settings/proxy', '/settings/security', '/settings/health', '/accounts', '/settings/accounts', '/accounts/new'];
